...
import { addPostAC, ProfileStateType, updateTextForTextAreaAC } from "../../../Redux/Profile-reducer";
...
const CreatePosts = () => {
    ...
    return (
        <div className={classes.create_posts}>
            <textarea className={classes.textarea} ref={newPostElement} value={profilePage.textForTextArea}
            ...
            <div><Post posts={profilePage.posts} /></div>
        </div>
